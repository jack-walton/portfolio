...
[docs.jackwalton.net](https://docs.jackwalton.net) — Portfolio featuring a user guide, a UX research paper, and an academic grant proposal.
...
**Languages**: HTML, CSS, XML, Markdown, JavaScript, PostgreSQL
